...
CREATE TABLE list_item_statuses (
	list_item_status_id int DEFAULT 1 NOT NULL,
...
ALTER TABLE list_items ADD CONSTRAINT FK_list_items_list_item_statuses FOREIGN KEY (list_item_status_id) REFERENCES list_item_statuses(list_item_status_id);

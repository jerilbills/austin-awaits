<template>
    <div class="sidebar is-dark">
        <span class="sidebar-header"><span class="icon"><i class="fa fa-home"></i></span>My Lists</span>
        <div v-if="lists.length > 0">
            <ul>
                <li v-for="list in inProgressLists" :key="list.listId"
                    @click="navigateTo(this.$store.state.user.departmentId, list.listId)">
        ...
        <div>
            <li class="add-list-button" @click="addListModal">Add List</li>
        </div>
        <ul>
        ...
        <span class="sidebar-header"><span class="icon"><i class="fa fa-filter"></i></span>Filters</span>
         <ul>
            <li :class="{ 'active': selectedOption === 'all' }"
                @click="navigateTo(this.$store.state.activeList.departmentId, this.$store.state.activeList.listId, 'all')">
                All
                Items</li>
